          ...
          <div className="sm: footerAbout flex  gap-15 md:flex justify-between ">
            ...
            <div className="sm: follow md:text-xl mr-3">
              ...
              <ul className='sm: flex flex-row  gap-3 text-SM pt-2'>
                <a href="https://github.com/imran071202"><FaGithub /></a>
                <a href="https://x.com/Imran___02"><FaXTwitter /></a>
                <a href="https://www.linkedin.com/in/imran-shaikh-163372241/"><FaLinkedin /></a>
              </ul>
            </div>
          </div>
